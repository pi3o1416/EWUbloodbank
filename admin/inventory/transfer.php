...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <?php
                    $link = "http://localhost/EWUbloodbank/admin/inventory/arrange_transfer.php?bagid=".$_GET['bagid'];
                
                echo "<form name='create_account' action='$link' class='needs-validated' method='post'>";
                ?>
                    <div class=" form-group">
                        <label for="center_id"><strong>Transfer to Donation Center*</strong></label>
                    ...
                    <button name="submit" type="submit" class="btn btn-primary">Move</button>
