...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light">
                            ...
                            <a class="dropdown-item" href="#">Current Request</a>
                            <a class="dropdown-item" href="#">Preveous Request</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light">
                            ...
                            <a class="dropdown-item" href="#">View Hospital</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light">
                            ...
                            <a class="dropdown-item" href="#">Donation Result</a>
                        </div>
                    </li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/donate/donate-now/store.php" class="needs-validated" method="post">
                    ...
                    <div class=" form-group">
                        <label for="center_id"><strong>Donation Camp*</strong></label>
