...
<body>
    ...
    <div class="container">
        ...
        <form name="create_account" action="http://localhost/EWUbloodbank/admin/search-user/" class="needs-validated" method="post">
            ...
            <div class=" form-group">
                ...
                <input type="text" class="form-control" id="fname" placeholder="joey" name="fname">
                <div class="valid-feedback">Valid</div>
                <div class="invalid-feedback">Please fill out this field</div>
            </div>
            ...
            <div class=" form-group">
                ...
                <input type="text" class="form-control" id="lname" placeholder="joey" name="lname">
                <div class="valid-feedback">Valid</div>
                <div class="invalid-feedback">Please fill out this field</div>
            </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody id="myTable">
            ...
            if (empty($_POST['email']) && empty($_POST['fname']) && empty($_POST['lname']) && empty($_POST['address'])) {
                ...
                $email = $_POST['email'];
                $sql = "SELECT * FROM user WHERE  fname = '$fname' and  lname = '$lname'  and city = '$address'";
            } else if (!empty($_POST['address'])) {
                $email = $_POST['email'];
                $sql = "SELECT * FROM user WHERE  city = '$address'";
            }
