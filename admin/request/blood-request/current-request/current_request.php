                    ...
                    if ($result == true) {
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row['req_status'] == 0) {
                                    $id = $row['req_id'];
                                    $link = "http://localhost/EWUbloodbank/admin/request/blood-request/current-request/add_result.php?id=" . $id."&center=".$row['req_center']."&amount=".$row['req_amount']."&blood=".$row['req_blood_g']."&rh=".$rh."&h_id=".$row['req_h_id']."&status=";
