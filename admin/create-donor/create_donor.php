...
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <h3 class="text-success"><strong>"There is no great joy than saving a soul"</strong></h3>
        ...
        <div class="row">
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/create-donor/checkifuser.php" class="needs-validated" method="post">
                    ...
                    <div class=" form-group">
                        <h6><b>Gender*</b></h6>
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="gcustom" name="gender" value="male">
                            <label class="custom-control-label" for="gcustom">Male</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="gcustom1" name="gender" value="female">
                            <label class="custom-control-label" for="gcustom1">Female</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="gcustom2" name="gender" value="other">
                            <label class="custom-control-label" for="gcustom2">Other</label>
                        </div>
                    </div>
                    ...
                    <button name="submit" type="submit" class="btn btn-primary">Become a Donor</button>
                    <?php
                    if ($_SESSION['error']) {
