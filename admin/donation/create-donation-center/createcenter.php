...
<body>
    ...
    <div class="container">
        ...
        <br><br><br>
        <h3 class="text-warning bg-light"><strong>Create a Donation center</strong> </h3>
        ...
        <div class="row">
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/donation/create-donation-center/center.php" class="needs-validated" method="post">

                    <div class="form-group">
                        <label for="name"><strong>Name*</strong></label>
                        <input type="text" class="form-control" id="name" placeholder="Ovijattrik Blood Donation Center" name="name" required>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" class="form-control" id="addr" placeholder="F-7 Extension Pallabi Mirpur Dhaka" name="addr" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>

                    <div class=" form-group">
                        <label for="cap"><strong>Capacity*</strong></label>
                        <input type="text" class="form-control" id="cap" placeholder="11" name="cap" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Efti@gmail.com" name="email" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>

                    <div class=" form-group">
                        <label for="phn"><strong>phone No*</strong></label>
                        <input type="text" class="form-control" id="phn" placeholder="+8801869519372" name="phn" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
