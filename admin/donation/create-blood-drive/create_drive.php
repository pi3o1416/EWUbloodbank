...
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <h3 class="text-dark"><strong>Create a Blood Drive</strong></h3>
            ...
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/donation/create-blood-drive/drive.php" class="needs-validated" method="post">
                    ...
                    <div class=" form-group">
                        <label for="drive_name"><strong>Blood Drive*</strong></label>
                        <input type="text" class="form-control" id="drive_name" placeholder="EWU blood donation camping" name="drive_name" required>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="extension pallabi mipur dhaka" name="address" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
