...
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <h3><strong>Hospital list</strong></h3>
        <div class="container mt-3">
            <h2>All Hospitals</h2>
            <p>Type Hospital Name or ID in the search box to filtered out the expected result:</p>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="myTable">
                    <?php
                    $sql = "SELECT * FROM hospital WHERE hospital.status = 'running';";
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>" . $row['h_email'] . "</td>
                                        <td>" . $row['h_phn'] . "</td>";
                                $link = 'http://localhost/EWUbloodbank/admin/hospital/view_h/edit.php?id=' . $row['h_id'];
