    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <?php
                $id = $_GET['id'];
                $link = "http://localhost/EWUbloodbank/admin/hospital/view_h/update.php?id=" . $id;
                ...
                $default = array("h_name", "address", "h_email", "h_phn");
                $title = array("Name", "Address", "Email", "Phone no");
                for ($i = 0; $i < 4; $i++) {
                    $temp = $row[$default[$i]];
                    echo "<div class='form-group'>
                            <label for= " . $default[$i] . "><strong>" . $title[$i] . "*</strong></label>
                            <input type= 'text' class = 'form-control '  id=" . $default[$i] . " name=" . $default[$i] . " value= '$temp'
