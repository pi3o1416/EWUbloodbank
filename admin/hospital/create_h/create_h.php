...
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <h3 class="text-dark"><strong>Add a Hospital</strong></h3>
        ...
        <div class="row">
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/hospital/create_h/hospital.php" class="needs-validated" method="post">

                    <div class="form-group">
                        <label for="name"><strong>Name*</strong></label>
                        <input type="name" class="form-control" id="name" placeholder="Islami Bank Hospital" name="name" required>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="addr" class="form-control" id="addr" placeholder="F-7 Extension Pallabi Mirpur Dhaka" name="addr" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="islamibank@gmail.com" name="email" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="phn" class="form-control" id="phn" placeholder="+8801869519372" name="phn" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
