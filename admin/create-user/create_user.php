...
<body>
    ...
    <div class="container">
        ...
        ?>
        <h3 class="text-danger"><strong>Welcome</strong> </h3>
        <h5 class="text-secondary">Please Complete the form below</h5>
        <br><br>
        <div class="row">
            <div class="col-sm-6">
                <form name="create_account" action="http://localhost/EWUbloodbank/admin/create-user/create.php" class="needs-validated" method="post">
                    <div class="form-group">
                        <label for="firstname"><strong>First Name*</strong></label>
                        <input class="form-control" id="firstname" placeholder="Tanjim" name="fname" required>
                    ...
                    <div class=" form-group">
                        ...
                        <input class="form-control" id="lastname" placeholder="Utsho" name="lname" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class=" form-group">
                        ...
                        <input type="password" class="form-control" id="rpwd" placeholder="Retype Password" name="rpswd" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class=" form-group">
                        ...
                        <input class="form-control" id="city" placeholder="Dhaka" name="city" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Please fill out this field</div>
                    </div>
                    ...
                    <div class="form-group form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="remember" required> I agree to the EWUbloodbank Privacy Policy, Terms and Conditions, and the Privacy Collection Statement above. *Required
                        </label>
                    </div>
                    <button name="submit" type="submin" class="btn btn-primary">Create Account</button>
                    <?php
                    if ($_SESSION['error']) {
